...
const LazyRegSuccess = lazy(() => import('/Users/atchayaraja/frontend/src/pages/register-successful.jsx'));
...
function App() {
  const router= createBrowserRouter([
    ...
    {
      path:'/reg-success',
      element:<Suspense fallback={<Spinner/>}><LazyRegSuccess/></Suspense>
    },
